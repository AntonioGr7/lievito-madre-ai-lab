...
Reference for all 8 bi-encoder recipes — each `configs/smoke_r<N>.yaml` is the minimal complete YAML for Recipe N (see [scripts/embedding_bi_encoder/README.md](../../../scripts/embedding_bi_encoder/README.md)).
