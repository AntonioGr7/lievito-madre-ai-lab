...
from bi_encoder.evaluate import build_evaluator
from bi_encoder.model import load_sentence_transformer
from bi_encoder.trainer import (
    BidirectionalCfg,
    BiEncoderTrainCfg,
    GradientCachingCfg,
    MatryoshkaCfg,
...
from bi_encoder.shared.config import (
    TrainConfig,
    compute_total_training_steps,
)
from bi_encoder.shared.preprocessing import assert_tokenizer_matches
...
def main() -> None:
    ...
    if bec.loss_name == "DistillKLDivLoss" and shape != "distill":
        raise ValueError(
            ...
            f"scripts/score_with_cross_encoder.py first."
        )
