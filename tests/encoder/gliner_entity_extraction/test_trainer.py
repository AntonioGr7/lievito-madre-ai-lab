...
def test_resolve_precision_auto_on_ampere():
    from lievito_madre_ai_lab.finetuning.encoder.gliner_entity_extraction.trainer import _resolve_precision
...
def test_gliner_train_cfg_carries_focal_fields():
    ...
    from lievito_madre_ai_lab.finetuning.encoder.gliner_entity_extraction.trainer import GLiNERTrainCfg
